      ...
      theme: ThemeData(fontFamily: 'CrimsonText-Bold'),
       ...
       onGenerateRoute: (RouteSettings settings) {
          ...
          var routes = <String, WidgetBuilder>{
            ...
            BarCityRatingPost.route: (context) => BarCityRatingPostState(settings.arguments),
            BarCollegePost.route: (context) => BarCollegePostState(settings.arguments),
            BarCollegeRatingPost.route: (context) => BarCollegeRatingPostState(settings.arguments),
            CityPost.route: (context) => CityPostState(settings.arguments),
            CityRatingPost.route: (context) => CityRatingPostState(settings.arguments),
            CollegePost.route: (context) => CollegePostState(settings.arguments),
            CollegeRatingPost.route: (context) => CollegeRatingPostState(settings.arguments),
            NbhoodCityPost.route: (context) => NbhoodCityPostState(settings.arguments),
            NbhoodCityRatingPost.route: (context) => NbhoodCityRatingPostState(settings.arguments),
            NbhoodCollegePost.route: (context) => NbhoodCollegePostState(settings.arguments),
            NbhoodCollegeRatingPost.route: (context) => NbhoodCollegeRatingPostState(settings.arguments),
            UserCityPost.route: (context) => UserCityPostState(settings.arguments),
            UserCityRatingPost.route: (context) => UserCityRatingPostState(settings.arguments),
            UserCollegePost.route: (context) => UserCollegePostState(settings.arguments),
            UserCollegeRatingPost.route: (context) => UserCollegeRatingPostState(settings.arguments),
            EditCityPost.route: (context) => EditCityPostState(settings.arguments),
            EditCollegePost.route: (context) => EditCollegePostState(settings.arguments)
          };
