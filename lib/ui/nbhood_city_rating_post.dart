...
import './nbhood_city_post.dart';

class NbhoodCityRatingPostState extends StatefulWidget {
  NbhoodCityRatingPostState(this.location);
  final String location;
  @override 
  NbhoodCityRatingPost createState() => NbhoodCityRatingPost();
}

class NbhoodCityRatingPost extends State<NbhoodCityRatingPostState>{
  static const route = '/nbhood/city/rating';
  ...
  getPosts(String locNeighborhood, [int start, String location, int rating]) async {
    var response;
    if (start != null) {
      try {
        response = await apiService.getCityNbhoodRating(locNeighborhood, start, location, rating);
      }
      catch(e) {
      ...
      response = await apiService.getCityNbhoodRating(locNeighborhood);
    }
    return response;
  }
