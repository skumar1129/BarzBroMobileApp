...
class NbhoodCityRatingPost extends State<NbhoodCityRatingPostState> {
  ...
  getPosts(String locNeighborhood,
      [int start, String location, int rating]) async {
    var response;
    if (start != null) {
      try {
        response = await apiService.getCityNbhoodRating(
            locNeighborhood, context, start, location, rating);
      } catch (e) {
        _scaffoldKey.currentState.showSnackBar(fail);
      }
    } else {
      response = await apiService.getCityNbhoodRating(locNeighborhood, context);
    }
    return response;
  }
                                      ...
                                      itemBuilder: (context, index) {
                                        if (index == items.length &&
                                          ...
                                          var newPosts = getPosts(
                                              items[startIndex].locNeighborhood,
