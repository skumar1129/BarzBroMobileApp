...
class UserCollegePost extends State<UserCollegePostState> {
  ...
  getPosts(String locUser, [int start, String school]) async {
    ...
    if (start != null) {
      try {
        response = await apiService.getSchoolUserTime(locUser, start, school);
      }
      catch(e) {
      ...
      response = await apiService.getSchoolUserTime(locUser);
    }
    return response;
  }
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          RaisedButton(
                            onPressed: () {
                              Navigator.pushReplacementNamed(context, UserCollegeRatingPost.route,
