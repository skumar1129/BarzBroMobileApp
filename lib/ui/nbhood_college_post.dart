...
class NbhoodCollegePost extends State<NbhoodCollegePostState> {
  ...
  getPosts(String schoolReg, [int start, String school]) async {
    ...
    if (start != null) {
      try {
        response = await apiService.getSchoolRegTime(schoolReg, start, school);
      }
      catch(e) {
      ...
      response = await apiService.getSchoolRegTime(schoolReg);
    }
    return response;
  }
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          RaisedButton(
                            onPressed: () {
                              Navigator.pushReplacementNamed(context, NbhoodCollegeRatingPost.route,
