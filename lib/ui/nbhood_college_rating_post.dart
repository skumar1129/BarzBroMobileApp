...
class NbhoodCollegeRatingPost extends State<NbhoodCollegeRatingPostState> {
  ...
  getPosts(String schoolReg, [int start, String location, int rating]) async {
    ...
    if (start != null) {
      try {
        response = await apiService.getSchoolRegRating(
            schoolReg, context, start, location, rating);
      } catch (e) {
        _scaffoldKey.currentState.showSnackBar(fail);
      }
    } else {
      response = await apiService.getSchoolRegRating(schoolReg, context);
    }
    return response;
  }
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        RaisedButton(
                          onPressed: () {
                            Navigator.pushReplacementNamed(
                                context, NbhoodCollegePost.route,
