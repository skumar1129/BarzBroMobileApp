...
class BarCityPost extends State<BarCityPostState> {
  ...
  getPosts(String locBar, [int start, String location]) async {
    ...
    if (start != null) {
      try {
        response = await apiService.getCityBarTime(locBar, start, location);
      }
      catch(e) {
      ...
      response = await apiService.getCityBarTime(locBar);
    }
    return response;
  }
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          RaisedButton(
                            onPressed: () {
                              Navigator.pushReplacementNamed(context, BarCityRatingPost.route,
