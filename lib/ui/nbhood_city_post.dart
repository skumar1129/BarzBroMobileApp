...
class NbhoodCityPost extends State<NbhoodCityPostState> {
  ...
  getPosts(String locNeighborhood, [int start, String location]) async {
    ...
    if (start != null) {
      try {
        response = await apiService.getCityNbhoodTime(
            locNeighborhood, context, start, location);
      } catch (e) {
        _scaffoldKey.currentState.showSnackBar(fail);
      }
    } else {
      response = await apiService.getCityNbhoodTime(locNeighborhood, context);
    }
    return response;
  }
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        RaisedButton(
                          onPressed: () {
                            Navigator.pushReplacementNamed(
                                context, NbhoodCityRatingPost.route,
