...
class CityPost extends State<CityPostState> {
  ...
  getPosts(String location, [int start]) async {
    ...
    if (start != null) {
      try {
        response = await apiService.getCityPosts(location, start);
      }
      catch(e) {
      ...
      response = await apiService.getCityPosts(location);
    }
    return response;
  }
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          RaisedButton(
                            onPressed: () {
                              Navigator.pushReplacementNamed(context, CityRatingPost.route,
