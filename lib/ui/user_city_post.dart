...
class UserCityPost extends State<UserCityPostState> {
  ...
  getPosts(String locUser, [int start, String location]) async {
    ...
    if (start != null) {
      try {
        response =
            await apiService.getCityUserTime(locUser, context, start, location);
      } catch (e) {
        _scaffoldKey.currentState.showSnackBar(fail);
      }
    } else {
      response = await apiService.getCityUserTime(locUser, context);
    }
    return response;
  }
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        RaisedButton(
                          onPressed: () {
                            Navigator.pushReplacementNamed(
                                context, UserCityRatingPost.route,
